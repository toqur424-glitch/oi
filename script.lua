...
--=============================================
-- [KICK 탭] - 블롭맨 오너 킥 (AlignPosition, SetOwner 1:2 비율)
--=============================================
...
KickTab:CreateToggle({
    Name = "블롭맨 오너 킥 실행 (AlignPosition, SetOwner 1:2 비율)",
    Callback = function(v)
...
Rayfield:Notify({Title = "로딩 완료", Content = "AlignPosition, SetOwner 1:2 비율, 350Hz", Duration = 3})
