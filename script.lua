...
local function startKickLoop()
    ...
    -- 2. 리모트 호출 (정밀 타이머, 350Hz, 1:3 비율 적용 - SetOwner 1회, Destroy 3회)
...
Rayfield:Notify({Title = "로딩 완료", Content = "안티그랩 유지, X=7, Y=20, 350Hz 정밀 타이머, SetOwner 1:Destroy 3 비율", Duration = 3})
