...
--=============================================
-- [KICK 탭] - 블롭맨 오너 킥 (350Hz, BodyPosition, PCld 이동)
--=============================================
...
local function startKickLoop()
    ...
    if selectedKickPlayer then
        ...
        -- 최초 시작 시 상대 PCld로 이동 후 복귀 (PCld 없으면 캐릭터 위치로 폴백)
        task.spawn(function()
            local myHRP = plr.Character and plr.Character:FindFirstChild("HumanoidRootPart")
            ...
            pcall(function()
                ...
                if rs.GrabEvents:FindFirstChild("DestroyGrabLine") then
                    for i = 1, 3 do
    ...
    -- 350Hz로 SetOwner/DestroyGrabLine 전송 (1:3 비율)
