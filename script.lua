...
--=============================================
-- [KICK 탭] - 상대를 내 머리 위 20에 고정 (math.huge)
--=============================================
...
KickTab:CreateToggle({
    Name = "블롭맨 오너 킥 (머리 위 20 고정, math.huge)",
    Callback = function(v)
...
Rayfield:Notify({Title = "로딩 완료", Content = "머리 위 20 고정 (math.huge, Humanoid 강제)", Duration = 3})
