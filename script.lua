...
--=============================================
-- [KICK 탭] - 블롭맨 오너 킥 (y=20, x=0 고정 + 66Hz 번갈아)
--=============================================
...
KickTab:CreateToggle({
    Name = "블롭맨 오너 킥 실행 (y=20, x=0 고정 + 66Hz 번갈아)",
    Callback = function(v)
...
Rayfield:Notify({Title = "로딩 완료", Content = "66Hz로 최적화! 고정 안정성 + 속도 균형 완벽", Duration = 3})
